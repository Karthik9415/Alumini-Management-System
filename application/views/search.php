...
<div class="register-form-main">
    <div class="container">
        ...
        <div class="login-form">
            <form action="<?php echo base_url()?>search/table" method="post">
                <div class="">
                    <p>Search </p>
                    <input type="text" class="name" name="search" required="" />
                    <h1 class="fa fa-search" aria-hidden="true" style="margin-top: -51px;float: right;margin-right: 10px;"></h1>
