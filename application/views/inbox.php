                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <nav class="link-effect-2" id="link-effect-2">
                            <ul class="nav navbar-nav">
                                ...
                                <li>
                                    <a href="message" class="effect-3">Compose Messages</a>
                                </li>

                                <li>
                                    <a href="<?php echo base_url()?>inbox/logout" class="effect-3">Logout</a>
                                </li>
            ...
            <form action="#" method="post">
                ...
                <div class="">
                    <div style="float:left;margin-top: -30px ">
                        <label style="color: #ef5861">From:</label><label><?php echo $rat['sender']?></label>
                    </div>
                    <hr style="height:2px;background-color: gray">
                    <div>
                        <label style="color: #ef5861">Message:</label><label><?php echo $rat['message']?></label>
                    </div>
                    <hr style="height:2px;background-color: gray">
                    <div style="float: right">
                        <label style="color: #ef5861">Time:</label><label><?php echo $rat['time']?></label>
                    </div>
                    <br>
                    <div style="float: right">
                        <label style="color: #ef5861">Date:</label><label><?php echo $rat['date']?></label>
                    </div>
