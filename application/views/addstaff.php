                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <nav class="link-effect-2" id="link-effect-2">
                            <ul class="nav navbar-nav">
                                <li class="active" >
                                    <a href="addstaff" class="effect-3">Add Staff</a>
                                </li>
                                <li>
                                    <a href="publishevent" class="effect-3">Publish Event</a>
                                </li>
                                <li>
                                    <a href="addstaff/logout" class="effect-3">Logout</a>
                                </li>
...
<div class="register-form-main">
    <div class="container">
        ...
        <div class="login-form">
            <form action="<?php echo base_url()?>addstaff/add" method="post">
                <div class="">
                    <p>Staff Id </p>
                    <input type="text" class="name" name="staffid" required="" />
                </div>
                <div class="">
                    <p>Name </p>
                ...
                <div class="">
                    <p>Description</p>
                    <input type="text" class="password" name="description" required="" />
                </div>
                <label class="anim">
